...
Most projects eventually need to interact with the programmer. You'll eventually wish for *annotations:* some way to convey extra information from the program to your LLLVM pass. There are several ways to build up annotation systems:
...
[clang plugins]: https://codecov.io/github/sampsyo/beets
